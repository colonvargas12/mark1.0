...
<head>
  <meta charset="UTF-8">
  <title>Ejercicio B3 – N compras de trajes</title>
...
<a style="margin-top:120px;
 ...
 <img style="width:100px;height:100px;margin-top:10px;margin-right:10px;box-shadow:0 0 15px blue;"
  ...
  <center><h1>Ejercicio B3 – N compras de trajes</h1>
  <p>Ingrese los precios de los trajes separados por coma:</p>
  <input type="text" id="preciosInput" placeholder="Ej: 3000,2500,2000">
