...
<head>
  <meta charset="UTF-8">
  <title>Ejercicio B9 – Clasificación de edades</title>
  <link rel="stylesheet" href="../css/ejercicio19.css">
</head>
<body>
...
<center> <h1>Ejercicio B9 – Clasificación de edades</h1>
  <p>Ingrese edades separadas por coma:</p>
  <input type="text" id="edadesInput" placeholder="Ej: 2,15,70">
  ...
  <script src="../js/ejercicio19.js"></script>
</body>
</html>
