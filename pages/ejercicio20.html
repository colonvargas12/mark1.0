...
<head>
  <meta charset="UTF-8">
  <title>Ejercicio B10 – N números días de la semana</title>
  <link rel="stylesheet" href="../css/ejercicio20.css">
</head>
<body>
...
<center> <h1>Ejercicio B10 – Días de la semana</h1>
  <p>Ingrese números del 1 al 7 separados por coma:</p>
  <input type="text" id="numerosInput" placeholder="Ej: 1,3,5">
  <button id="btnCalcular">Mostrar Días</button></center> 
