...
<head>
  <meta charset="UTF-8">
  <title>Ejercicio B8 – N paquetes paquetería</title>
  <link rel="stylesheet" href="../css/ejercicio18.css">
</head>
<body>
...
<center>  <h1>Ejercicio B8 – N paquetes paquetería</h1>
  <p>Ingrese los paquetes en formato Peso,Zona separados por coma:</p>
  <input type="text" id="paquetesInput" placeholder="Ej: 4,Europa;5,Asia">
  <button id="btnCalcular">Calcular Costo de Envío</button></center>
