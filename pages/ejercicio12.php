...
<head>
  <meta charset="UTF-8">
  <title>Ejercicio B2 – N compras de lápices</title>
  <link rel="stylesheet" href="../css/ejercicio12.css">
</head>
<body>
...
<a style="margin-top:120px;
 ...
 <img style="width:100px;height:100px;margin-top:10px;margin-right:10px;box-shadow:0 0 15px blue;"
  ...
  <center><h1>Ejercicio B2 – N compras de lápices</h1>
  <p>Ingrese las cantidades separadas por coma:</p>
  <input type="text" id="pedidosInput" placeholder="Ej: 1200,800">
  <button id="btnCalcular">Calcular</button></center>
