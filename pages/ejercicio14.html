...
<head>
  <meta charset="UTF-8">
  <title>Ejercicio B4 – N viajes en autobús</title>
...
<center>  <h1>Ejercicio B4 – N viajes en autobús</h1>
  <p>Ingrese los viajes separados por coma. Formato: Tipo,Distancia,Personas</p>
  <input type="text" id="viajesInput" placeholder="Ej: A,100,15;B,50,25">
